...
export default interface StandardPage {
  main: any;
  title:string;
}
export class StandardPageBuilder{
  static build(props:any) {
    props = transformNode({...props});
    class StandardPageInstance implements StandardPage {
      title:string;
        main: any;
    ...
    return new StandardPageInstance(props);
  }
}
