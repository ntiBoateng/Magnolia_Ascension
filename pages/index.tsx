...
import { UxfAlert, UxfButton } from '@magnolia-ea/uxf-react';
  ...
  return (
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        <h2>Magnolia Headless</h2>
        <UxfButton variant="success">UXF Button is working</UxfButton>        
