...
export default interface TextAndImage {
...
export class TextAndImageBuilder{
  static build(props:any) {
    props = transformNode({...props});
    class TextAndImageInstance implements TextAndImage {
      headlineLevel:string;
      headline:string;
      text:string;
      image:Asset;
    ...
    return new TextAndImageInstance(props);
  }
}
