...
export default interface ColumnLayout {
  column1: any;
  column2: any;
  column3: any;
  column4: any;
...
export class ColumnLayoutBuilder{
  static build(props:any) {
    props = transformNode({...props});
    class ColumnLayoutInstance implements ColumnLayout {
      comboSelect:string;
        column1: any;
        column2: any;
        column3: any;
    ...
    return new ColumnLayoutInstance(props);
  }
}
